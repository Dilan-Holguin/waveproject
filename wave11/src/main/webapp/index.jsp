<%-- 
    Document   : index
    Created on : 23 nov 2023, 19:24:07
    Author     : yungk
...
<%
    // Obtiene el valor del atributo de sesión 'usuario'
    usuario usuario = (usuario) session.getAttribute("usuario");

    // Imprime el valor como una variable de JavaScript
    out.println("<script>");
    out.println("var usuarioEnSesion = " + (usuario != null ? "'" + usuario + "'" : "null") + ";");
    out.println("</script>");
%>
<!DOCTYPE html>
<!doctype html>
...
<body>
                                ...
                                <div class="social_icon text-right">
                                    <ul>
                                        ...
                                        <% if(session.getAttribute("usuario") != null) { %>
                                            ...
                                            <li><a class="button custom-link" href="LogoutServlet">Salir</a></li>
                                        <% } else { %>
                                            <li id="loginStatus" onclick="showLoginPopup()" class="button custom-button">Iniciar sesión</li>
                                        <% } %>
                                        <!-- <li id="loginStatus"  href="javascript:void(0);" onclick="showLoginPopup()" class="button custom-button">Login</li> -->
                                    </ul>
                                </div>
                            </div>
                            <div class="col-12">
    ...
    <div class="music_area">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-xl-10">
                    <div class="row align-items-center justify-content-center"> <!-- Agregado el justify-content-center aquí -->
                        <div class="col-xl-9 col-md-9">
                            <div class="music_field text-center"> <!-- Agregado text-center aquí -->
                                <iframe style="border-radius:12px"
                                    src="https://open.spotify.com/embed/track/4MpMztfpLco5T8Cp0J4lQ2?utm_source=generator&theme=0"
            ...
            <div class="row align-items-center">
                <div class="col-xl-5 col-md-6">
                    <div class="about_thumb">
                        <img class="img-fluid" src="img\about\beefie.png" alt="">
                    </div>
                </div>
                <div class="col-xl-7 col-md-6">
                    <div class="about_info">
                        <h3>Yung Beef</h3>
                        <p>Yung Beef, de nombre Fernando Gálvez Gómez, es un rapero granadino nacido en 1990, que formó
                            parte de Los Santos y PXXR GVNG. Su nombre artístico tiene su origen en el título de una
                            canción de Lana del Rey, “Young and Beautiful”.</p>
    ...
    // Llama a la función para actualizar el estado de inicio de sesión cuando se carga la página
    window.onload = updateLoginStatus;
      
    </script>
    <!-- Ventana emergente para inicio de sesión y registro -->
         <!-- Ventana emergente para inicio de sesión y registro -->
